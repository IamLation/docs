...
<Steps>
  <Step title="Install (or update) dependencies" stepNumber={1}>
    ...
    <Columns cols={2}>
      <Card title="oxmysql" icon="arrow-up-right-from-square" href="https://github.com/overextended/oxmysql/releases/latest">
        Download oxmysql
      </Card>
      <Card title="ox_lib" icon="arrow-up-right-from-square" href="https://github.com/overextended/ox_lib/releases/latest">
        Download ox_lib
      </Card>
    </Columns>
  </Step>
