...
<ParamField path="iconColor" default="Auto" type="string">
...
<ParamField path="bgColor" default="Auto" type="string">
...
<ParamField path="txtColor" default="Auto" type="string">
...
<ParamField path="titleColor" default="Auto" type="string">
